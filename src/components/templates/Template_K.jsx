...
export default function DoctorProfile(props) {
  ...
  const defaultProps = {
    ...
    name: "Dr. Elizabeth R. Montgomery",
    position: "Board Certified Cardiologist",
    hospital: "Metropolitan Medical Center",
    specialty: "Interventional Cardiology",
    telephoneNo: "+1 (212) 555-0198",
    email: "dr.montgomery@metromedical.com",
    address: "200 Park Avenue, New York, NY 10166",
    socialLinks: {
      linkedIn: "https://linkedin.com/in/drmontgomery",
      twitter: "https://twitter.com/dremontgomery",
    },
    summary:
      "Board-certified cardiologist with 15+ years of experience in diagnosing and treating complex cardiovascular conditions. Specializing in interventional procedures, preventive cardiology, and holistic patient care with a focus on improving quality of life through evidence-based medicine.",
    coreCompetencies: [
      { value: "Interventional Cardiology" },
      { value: "Cardiac Catheterization" },
      { value: "Echocardiography" },
      { value: "Preventive Cardiology" },
    ...
    experience: [
      {
        ...
        years: "2018-Present",
        achievements: [
          { value: "Performed 500+ successful cardiac catheterizations with 99% success rate" },
          { value: "Developed innovative treatment protocols reducing readmission rates by 35%" },
          { value: "Led multidisciplinary team managing 2,000+ patients annually" },
        ],
      },
      {
        ...
        years: "2012-2018",
        achievements: [
          { value: "Established specialized clinic for preventive cardiology serving 150+ patients monthly" },
          { value: "Implemented patient education program improving medication adherence by 45%" },
          { value: "Participated in clinical trials advancing treatment options for heart failure" },
        ],
      },
    ],
    education: [
    ...
    certifications: [
      ...
      {
        name: "Certification in Echocardiography",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 w-24 h-24 bg-cyan-400/10 rounded-full blur-2xl animate-bounce"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-40 h-40 bg-blue-600/5 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-40 right-10 w-28 h-28 bg-indigo-500/10 rounded-full blur-2xl animate-bounce"
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="relative z-10 p-8 lg:p-12">
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div className="relative group">
                  ...
                  <div
                    className="absolute -bottom-2 -left-2 p-3 bg-cyan-500 rounded-full shadow-lg animate-bounce"
                    style={{ animationDelay: "1s" }}
                  >
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p
                    className="text-xl lg:text-2xl text-blue-300 font-semibold mb-2 animate-fadeInUp"
                    style={{ animationDelay: "0.2s" }}
                  >
                    {data.position}
                  </p>
                  <p className="text-lg text-blue-400 mb-6 animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
                    {data.hospital} • {data.specialty}
                  </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-blue-400/30">
                ...
                <p className="text-blue-100 leading-relaxed text-lg">{data.summary}</p>
              </div>
                  ...
                  {data.experience.map((exp, index) => (
                    <div key={index} className="relative pl-8 border-l-2 border-blue-500/30">
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-blue-300 font-semibold">{exp.hospital}</p>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-blue-400/30">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-white">Clinical Expertise</h2>
                </div>
                <div className="grid gap-3">
                  {data.coreCompetencies.map((skill, index) => (
                    <div
                      key={index}
                      className="bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm rounded-xl px-4 py-3 border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 hover:scale-105"
                    >
              ...
              <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-blue-400/30">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-white">Board Certifications</h2>
                </div>
                <div className="space-y-4">
              ...
              <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-blue-400/30">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-white">Practice Location</h2>
                </div>
                ...
                <div className="flex gap-4 mt-6">
                  <a
                    ...
                    className="p-3 bg-blue-600 hover:bg-blue-500 rounded-xl transition-colors duration-300"
                  >
                  ...
                  <a
                    ...
                    className="p-3 bg-cyan-600 hover:bg-cyan-500 rounded-xl transition-colors duration-300"
                  >
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 bg-slate-800/60 backdrop-blur-xl px-6 py-3 rounded-full border border-blue-500/20">
              ...
              <span className="text-blue-200 text-sm font-medium">Accepting New Patients</span>
            </div>
          </div>
        </div>
      </div>
