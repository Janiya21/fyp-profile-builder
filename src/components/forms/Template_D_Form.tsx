...
export function TemplateDForm({ onSubmit }: { onSubmit: (data: PortfolioFormData) => void }) {

  const { register, handleSubmit, getValues,
    setValue, formState: { errors, isValid }, control } = useForm({
  ...
  //   const parseNestedFields = (data: Record<string, any>) => {
  ...
  //   const data = parseNestedFields(Object.fromEntries(formData.entries()));
  //   console.log(data); // Now properly nested
  //   // onSubmit(data);
  // };
