...
export function TemplateAForm({ onSubmit }: { onSubmit: (data: PortfolioFormData) => void }) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="lg:p-6 p-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <Input
                label="Phone Number (+94 123 456 789)"
                type="text"
          ...
          <div className="space-y-4">
            ...
            {experiences.map((_, index) => (
              <div key={index} className="border border-gray-200 rounded-lg lg:p-4 p-2 relative group">
